...
import com.example.movies.WatchList
...
class WatchListAdapter(
    ...
    inner class WatchListHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val poster: ImageView = itemView.findViewById(R.id.item_fav_poster)
        private val name : TextView = itemView.findViewById(R.id.Favname)
        private val desc: TextView = itemView.findViewById(R.id.Favdesc)
